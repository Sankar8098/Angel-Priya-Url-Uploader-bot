...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5909685271:AAGrx4Ghfrwvw_J9DH2WS2nXLjAjLF6BrTM")
    ...
    HTTP_PROXY = os.environ.get("HTTP_PROXY", "54.227.197.196")
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "5821871362").split())
